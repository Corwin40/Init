...
const HomePage = (props) => {
    return(
        <div className="jumbotron">
            ...
            <hr className="my-4"/>
                <p>Si en cliquant sur un hyperlien, tu tombes sur cette page, c'est que l'application est en cours de développement.<br/>Le module où la page sera bientôt disponible</p>
                <p className="lead">
